...
set DESIGN_NAME                   "Rocket"  ;#  The name of the top-level design
...
set DESIGN_REF_DATA_PATH          "../src/rtl/rocketchip_default"  ;#  Absolute path prefix variable for library/design data.
...
set ADDITIONAL_SEARCH_PATH        "../src/rtl/rocketchip_default"  ;#  Additional search path to be added to the default search path
