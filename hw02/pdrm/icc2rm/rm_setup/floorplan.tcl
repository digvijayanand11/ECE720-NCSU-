...
# Offsets: Site width * 4 and Site height
set CORE_UTILIZATION 0.68
set left_right_io2core [expr 0.48*4.0]
set top_bottom_io2core [expr 3.33]
...
create_pg_std_cell_conn_pattern rail_pattern -layers met1
...
set HSTRAP_LAYER met5
set HSTRAP_WIDTH 1.6
set HSTRAP_PITCH 27.2
set VSTRAP_LAYER met4
set VSTRAP_WIDTH 1.5
set VSTRAP_PITCH 27.3
# met5: Width: N routing tracks (1.6+1.6)*N+1.6, Pitch M routing tracks (1.6*1.6)*M
